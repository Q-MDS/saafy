<div style="display: flex; align-items: center; justify-content: center; width: 100%; height: 375px;">
	<div class="container">
		<!-- Title -->
		<div class="row" style="width: 100%; margin-bottom: 20px;">
			<div class="three columns">&nbsp;</div>
			<div class="six columns">
				<div class="landing-title">Find Trusted Local Professionals</div>
			</div>
			<div class="three columns">&nbsp;</div>
		</div>
		<!-- Search bar -->
		 <div class="row">
			...
			<div class="eight columns">
				...
				<div style="display: flex; flex-direction: row; align-items: center; ">
					<div style="display: flex; align-items: center; justify-content: center; width: 50px; height: 59px; background: #fff; border-radius: 30px 0px 0px 30px">
